module.exports = [
  { text: '酷炫主页', link: '/' },
  {
    ...
    items: [
      ...
      { text: '低照度增强', link: '/deeplearning/lowlightenhancement' },
    ]
  },
  {
    text: '🎉算法',
    link: '/algorithm/',
    items: [
      { text: '算法基础思想', link: '/algorithm/basis' },
      { text: '刷题记录', link: '/algorithm/basisframework' },
      { text: '奇怪的算法记录', link: '/algorithm/imageclassification' },
      { text: '杂项笔记', link: '/algorithm/objectdetection' },
    ]
  },
  {
    text: '👀开发技术',
  ...
  },
  {
    ...
    items: [
      ...
      { text: '算法设计与分析', link: '/courses/algorithm/coucept' },
      { text: '操作系统', link: '/courses/operatingsystem/concept' },
      { text: '计算机网络', link: '/courses/computernetwork' },
      { text: '软件工程与UML', link: '/study/f78c0f/' },
      { text: '大数据分析和原理', link: '/study/fd1213/' },
  ...
  },
  {
    ...
    link: '/linux/',
    items: [
      { text: '备忘录', link: '/linux/memo/' },
      { text: '问题解决方案', link: '/linuxsolution/' },
    ]
  },
  // {text: '😊关于', link: '/about/'},
  {
